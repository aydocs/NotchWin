...
namespace NotchWin.Main
{
    public class Settings
    {
        ...
        public static void InitializeSettings()
        {
            try
            {
                ...
                else
                {
                    ...
                    smallWidgetsRight.Add("NotchWin.UI.Widgets.Small.RegisterSmallVisualiserWidget");
                    smallWidgetsLeft.Add("NotchWin.UI.Widgets.Small.RegisterMediaThumbnailWidget");
                    bigWidgets.Add("NotchWin.UI.Widgets.Big.RegisterWeatherWidget");
                    bigWidgets.Add("NotchWin.UI.Widgets.Big.RegisterTimerWidget");
            ...
            {
                MessageBox.Show("An error occured trying to load the settings. Please revert back to the default settings by deleting the \"Settings.json\" file located under \"%appdata%/NotchWin/\".");
        ...
        {
            NotchWin.Utils.Theme.Instance.UpdateTheme();
