...
namespace NotchWin.Utils
{
    internal class PopupOptions : IRegisterableSetting
    {
        ...
        public List<UIObject> SettingsObjects()
        {
            ...
            var volume = new NWCheckbox(null, "Display volume pop-up", new Vec2(25, 0), new Vec2(25, 25), null, UIAlignment.TopLeft);
            ...
            var brightness = new NWCheckbox(null, "Display brightness pop-up", new Vec2(25, 0), new Vec2(25, 25), null, UIAlignment.TopLeft);
