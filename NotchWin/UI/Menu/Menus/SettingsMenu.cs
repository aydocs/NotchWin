...
using NotchWin.UI.Menu.Menus.SettingsMenuObjects;
using NotchWin.UI.UIElements;
using NotchWin.UI.UIElements.Custom;
...
using static NotchWin.UI.UIElements.IslandObject;
...
namespace NotchWin.UI.Menu.Menus
{
    public class SettingsMenu : BaseMenu
    {
        ...
        NWMultiSelectionButton bigMenuModeSelector;
        ...
        NWCheckbox allowBlur;
        NWCheckbox allowAnimation;
        NWCheckbox antiAliasing;
        NWCheckbox runOnStartup;

        NWCheckbox alwaysTopmost;
        NWCheckbox toggleIslandShadow;
        NWCheckbox toggleHomeMenuShadow;
        NWCheckbox toggleHighRefreshRate;
        NWCheckbox limitRefreshRateWhenIdle;

        NWText refreshRateDisclaimer1, refreshRateDisclaimer2, limitRefreshRateDisclaimer1, limitRefreshRateDisclaimer2, workingAreaDisclaimer1, workingAreaDisclaimer2;
        ...
        public override List<UIObject> InitializeMenu(IslandObject island)
        {
            ...
            var generalTitle = new NWText(island, "General", new Vec2(25, 0), UIAlignment.TopLeft);
            generalTitle.Font = Res.SFProBold;
            generalTitle.Anchor.X = 0;
            objects.Add(generalTitle);

            {
                var islandModesTitle = new NWText(island, "Island Mode", new Vec2(25, 0), UIAlignment.TopLeft);
                ...
                var islandMode = new NWMultiSelectionButton(island, islandModes, new Vec2(25, 0), new Vec2(IslandSize().X - 50, 25), UIAlignment.TopLeft);
            ...
            workingAreaDisclaimer1 = new NWText(island, "Renders the interface to its minimum height and width possible, also improves performance.", new Vec2(25, 0), UIAlignment.TopLeft);
            workingAreaDisclaimer1.Font = Res.SFProRegular;
            workingAreaDisclaimer1.TextSize = 12;
            workingAreaDisclaimer1.Anchor.X = 0;

            workingAreaDisclaimer2 = new NWText(island, "Disabling this setting may prevent the interface from being placed correctly at the top.", new Vec2(25, 0), UIAlignment.TopLeft);
            ...
            allowBlur = new NWCheckbox(island, "Toggle blur", new Vec2(25, 0), new Vec2(25, 25), () => { }, UIAlignment.TopLeft);
            allowBlur.IsChecked = Settings.AllowBlur;
            allowBlur.Anchor.X = 0;
            objects.Add(allowBlur);

            allowAnimation = new NWCheckbox(island, "Toggle animations", new Vec2(25, 0), new Vec2(25, 25), () => { }, UIAlignment.TopLeft);
            allowAnimation.IsChecked = Settings.AllowAnimation;
            allowAnimation.Anchor.X = 0;
            objects.Add(allowAnimation);

            antiAliasing = new NWCheckbox(island, "Toggle anti-aliasing", new Vec2(25, 0), new Vec2(25, 25), () => { }, UIAlignment.TopLeft);
            antiAliasing.IsChecked = Settings.AntiAliasing;
            antiAliasing.Anchor.X = 0;
            objects.Add(antiAliasing);

            refreshRateDisclaimer1 = new NWText(island, "Enables application to run at the highest refresh rate supported by your monitor.", new Vec2(25, 0), UIAlignment.TopLeft);
            refreshRateDisclaimer1.Font = Res.SFProRegular;
            refreshRateDisclaimer1.TextSize = 12;
            refreshRateDisclaimer1.Anchor.X = 0;

            refreshRateDisclaimer2 = new NWText(island, "This setting will cause performance degradation on some devices, proceed with caution.", new Vec2(25, 0), UIAlignment.TopLeft);
            refreshRateDisclaimer2.Font = Res.SFProRegular;
            refreshRateDisclaimer2.TextSize = 12;
            refreshRateDisclaimer2.Anchor.X = 0;

            toggleHighRefreshRate = new NWCheckbox(
                island,
            ...
            limitRefreshRateWhenIdle = new NWCheckbox(
                island,
            ...
            limitRefreshRateDisclaimer1 = new NWText(
                island,
            ...
            limitRefreshRateDisclaimer2 = new NWText(
                island,
            ...
            toggleIslandShadow = new NWCheckbox(
                island,
            ...
            toggleHomeMenuShadow = new NWCheckbox(
                island,
            ...
            runOnStartup = new NWCheckbox(island, "Start application on login", new Vec2(25, 0), new Vec2(25, 25), () => { }, UIAlignment.TopLeft);
            ...
            {
                var selectedMonitorTitle = new NWText(island, "Selected Monitor", new Vec2(25, 0), UIAlignment.TopLeft);
                ...
                var selectedMonitor = new NWMultiSelectionButton(island, selectedMonitors, new Vec2(25, 0), new Vec2(IslandSize().X - 50, 25), UIAlignment.TopLeft);
            ...
            {
                var bigMenuModeTitle = new NWText(island, "Default Big Menu Mode", new Vec2(25, 0), UIAlignment.TopLeft);
                ...
                bigMenuModeSelector = new NWMultiSelectionButton(island, bigMenuModes, new Vec2(25, 0), new Vec2(IslandSize().X - 50, 25), UIAlignment.TopLeft);
            ...
            {
                var themeTitle = new NWText(island, "Themes", new Vec2(25, 0), UIAlignment.TopLeft);
                ...
                var theme = new NWMultiSelectionButton(island, themeOptions, new Vec2(25, 0), new Vec2(IslandSize().X - 50, 25), UIAlignment.TopLeft);
            ...
            objects.Add(new NWText(island, " ", new Vec2(0, 0))
            {
                TextSize = 2
            });

            var widgetsTitle = new NWText(island, "Widgets", new Vec2(25, 0), UIAlignment.TopLeft);
            ...
            {
                var wTitle = new NWText(island, "Small widgets (right click to add/edit)", new Vec2(25, 0), UIAlignment.TopLeft);
            ...
            {
                var wTitle = new NWText(island, "Big widgets (right click to add/edit)", new Vec2(25, 15), UIAlignment.TopLeft);
                wTitle.Font = Res.SFProBold;
                wTitle.Color = Theme.TextMain;
                wTitle.TextSize = 15;
                wTitle.Anchor.X = 0;
            ...
            objects.Add(new NWText(island, " ", new Vec2(25, 0), UIAlignment.TopLeft)
            {
            ...
            var widgetOptionsTitle = new NWText(island, "Widget Settings", new Vec2(25, 0), UIAlignment.TopLeft);
...

            {
                ...
                {
                    var wTitle = new NWText(island, option.SettingTitle, new Vec2(25, 0), UIAlignment.TopLeft);
                    wTitle.Font = Res.SFProBold;
                    wTitle.TextSize = 15;
                    wTitle.Anchor.X = 0;
                    objects.Add(wTitle);
                    ...
                    foreach (var optionItem in option.SettingsObjects())
                    {
                        ...
                        if (optionItem is NWText)
                        {
                            ((NWText)optionItem).Color = Theme.TextMain;
                            ((NWText)optionItem).Font = Res.SFProRegular;
                            ((NWText)optionItem).TextSize = 13;
                        }
                        else if (optionItem is NWCheckbox)
                        {
            ...
            objects.Add(new NWText(island, $"Application version: {NotchWinMain.Version}", new Vec2(25, -15), UIAlignment.TopLeft)
            {
            ...
            objects.Add(new NWText(island, $"Software architecture: {NotchWinMain.ProcessArchitecture.ToString().ToLower()}", new Vec2(25, -25), UIAlignment.TopLeft)
            {
                Color = Theme.TextMain,
                Anchor = new Vec2(0, 0),
                TextSize = 13,
