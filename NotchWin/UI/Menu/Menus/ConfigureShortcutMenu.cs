    ...
    internal class ConfigureShortcutMenu : BaseMenu
    {
        ...
        private void PDropData(System.Windows.DragEventArgs e)
        {
            ...
            if (fileList != null && fileList.Length > 0)
            {
                ...
                elementText.SetText(NWText.Truncate(fileList[0], 60));
                elementTitle.SetText(NWText.Truncate(name, 25));
            }
        ...
        public override List<UIObject> InitializeMenu(IslandObject island)
        {
            ...
            NWTextButton saveAndBack = new NWTextButton(island, "Save & Back", new Utils.Vec2(0, -30), new Utils.Vec2(IslandSize().X - 30, 30), () =>
            {
            ...
            elementTitle = new NWText(island, "Untitled", new Vec2(25, 25), UIAlignment.TopLeft);
            ...
            elementText = new NWText(island, " ", new Vec2(0, 55 + 75 / 2));
