...
namespace NotchWin.UI.Menu.Menus
{
    public class HomeMenu : BaseMenu
    {
        ...
        NWTextImageButton widgetButton;
        NWTextImageButton trayButton;
        NWTextImageButton mediaButton;
        ...
        public override List<UIObject> InitializeMenu(IslandObject island)
        {
            ...
            widgetButton = new NWTextImageButton(topContainer, Resources.Res.Widgets, "Widgets", new Vec2(75 / 2 + 5, 0), new Vec2(75, 20), () =>
            {
            ...
            trayButton = new NWTextImageButton(topContainer, Resources.Res.Tray, "Tray", new Vec2(112.5f, 0), new Vec2(57.5f, 20), () =>
            {
                // Switch to tray view
            ...
            mediaButton = new NWTextImageButton(topContainer, Resources.Res.PlayPause, "Media", new Vec2(158.5f + 20, 0), new Vec2(65, 20), () =>
            {
