...
namespace NotchWin.UI.Menu.Menus
{
    public class TimerOverMenu : BaseMenu
    {
        ...
        public override List<UIObject> InitializeMenu(IslandObject island)
        {
            ...
            overText = new NWText(island, "Timer Over!", new Utils.Vec2(0, 0), UIAlignment.Center)
            {
                TextSize = 20,
            ...
            wave = new NWWave(island, IslandSize());
    ...
    internal class NWWave : UIObject
    {
        public NWWave(UIObject? parent, Vec2 size, UIAlignment alignment = UIAlignment.Center) : base(parent, Vec2.zero, size, alignment)
        {
