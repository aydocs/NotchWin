...
using static NotchWin.UI.Widgets.Small.RegisterUsedDevicesOptions;
...
namespace NotchWin.UI.Widgets.Small
{
    ...
    class RegisterTimeWidgetSettings : IRegisterableSetting
    {
        ...
        public List<UIObject> SettingsObjects()
        {
            ...
            var militaryTime = new NWCheckbox(null, "Use 24-hour format", new Vec2(25, 0), new Vec2(25, 25), null, UIAlignment.TopLeft);
