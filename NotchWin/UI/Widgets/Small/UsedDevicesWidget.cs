...
namespace NotchWin.UI.Widgets.Small
{
    ...
    class RegisterUsedDevicesOptions : IRegisterableSetting
    {
        ...
        public List<UIObject> SettingsObjects()
        {
            ...
            var thresholdSlider = new NWSlider(null, new Vec2(0, 0), new Vec2(400, 25));
            ...
            var enableIndicatorCheckbox = new NWCheckbox(null, "Display microphone indicator", new Vec2(25, 0), new Vec2(25, 25), null, alignment: UIAlignment.TopLeft);
            enableIndicatorCheckbox.IsChecked = saveData.enableIndicator;

            var thresholdText = new NWText(null, "Threshold", new Vec2(25, 0), UIAlignment.TopLeft);
    ...
    internal class LoudnessMeter : NWProgressBarEx
    {
        ...
        {
            return (float)Math.Sqrt(((NotchWinMain.defaultMicrophone == null) ? 0f : NotchWinMain.defaultMicrophone.AudioMeterInformation.MasterPeakValue) + 0.001);
        }
    }
