...
{
    public class NWButton : UIObject
    {
        // Button Color
        ...
        public NWButton(UIObject? parent, Vec2 position, Vec2 size, Action clickCallback, UIAlignment alignment = UIAlignment.TopCenter) : base(parent, position, size, alignment)
        {
            initialScale = size;
