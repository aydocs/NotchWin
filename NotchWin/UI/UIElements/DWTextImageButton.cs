...
{
    public class NWTextImageButton : NWButton
    {
        NWText text;
        ...
        public NWTextImageButton(UIObject? parent, SKBitmap image, string buttonText, Vec2 position, Vec2 size, Action clickCallback, UIAlignment alignment = UIAlignment.TopCenter) : base(parent, position, size, clickCallback, alignment)
        {
            text = new NWText(this, buttonText, new Vec2(-7.5f, 0), UIAlignment.MiddleRight);
            text.Anchor.X = 0f;
            AddLocalObject(text);
