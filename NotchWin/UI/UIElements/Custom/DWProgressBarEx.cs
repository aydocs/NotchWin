...
{
    /// <summary>
    /// Successor to NWProgressBar: exposes clamped Value (0..1), smoothing, colors and immediate-set API.
    /// Designed to be reusable across widgets.
    /// </summary>
    public class NWProgressBarEx : UIObject
    {
        ...
        public NWProgressBarEx(UIObject? parent, Vec2 position, Vec2 size, UIAlignment alignment = UIAlignment.TopCenter,
