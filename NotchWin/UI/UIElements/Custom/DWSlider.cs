...
{
    public class NWSlider(UIObject? parent, Vec2 position, Vec2 size, UIAlignment alignment = UIAlignment.TopCenter) : NWProgressBarEx(parent, position, size, alignment)
    {
