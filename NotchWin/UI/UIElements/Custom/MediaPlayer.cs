...
namespace NotchWin.UI.UIElements.Custom
{
    public class MediaPlayer : UIObject
    {
        ...
        private NotchWin.Utils.Media? currentMedia;
        ...
        private NotchWin.Utils.Media? pendingMedia; // Pending metadata object
        ...
        private NWProgressBarEx? timelineBar;
        ...
        public MediaPlayer(UIObject? parent, Vec2 position, Vec2 size, UIAlignment alignment = UIAlignment.TopCenter) : base(parent, position, size, alignment)
        {
            ...
            try
            {
                timelineBar = new NWProgressBarEx(this, new Vec2(0, 0), new Vec2(200, timelineHeight), UIAlignment.TopCenter,
            ...
            _ = Task.Run(async () =>
            {
                while (!token.IsCancellationRequested)
                {
                    try
                    {
                        ...
                        byte[]? svcBytes = null;
                        NotchWin.Utils.Media? svcMedia = null;
        ...
        public override void Draw(SKCanvas canvas)
        {
            ...
            if (!string.IsNullOrEmpty(fullTitleText))
            {
                ...
                {
                    var truncated = NWText.Truncate(fullTitleText, titleScrollCharThreshold);
            ...
            {
                var displayArtist = NWText.Truncate(artist, 45);
            ...
            try
            {
                ...
                // If we have a NWProgressBarEx instance, position it and draw it
                if (timelineBar != null)
                {
