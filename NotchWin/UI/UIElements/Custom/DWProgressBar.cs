...
{
    [Obsolete("NWProgressBar is deprecated. Use NWProgressBarEx instead.")]
    public class NWProgressBar : UIObject
    {
        ...
        public NWProgressBar(UIObject? parent, Vec2 position, Vec2 size, UIAlignment alignment = UIAlignment.TopCenter) : base(parent, position, size, alignment)
        {
            roundRadius = 15f;
